<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.IDologySuccessful" Title="IDology Successful"
    CodeBehind="IDologySuccessful.aspx.cs" %>
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="h1title">
                            <span class="indnt Phead" style="padding-left: 15px;">Congratulations!</span>
                        </td>
                    </tr>
                    <tr class="h2title">
                    ...
                    <tr>
                        <td>
                            <div>
                                <asp:Panel ID="pnlIDProofSuccessful" runat="server">
                                    <p style="padding-top: 10px; padding-left: 15px;">
                                       <asp:Label ID="lblCongrats" runat="server" Text="Congratulations! you are now able to use ePrescribe.<br />
                                        Click Next to start ePrescribing.<br />"></asp:Label>
                                        <br />
                                        <asp:Button ID="btnNext" runat="server" OnClick="btnNext_Click" CssClass="btnstyle"
                    ...
                    <tr>
                        <td colspan="2" align="left" style="padding-bottom: 10px; padding-left: 10px; padding-right: 10px">
                            ...
                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="mailto:eprescribesupport@allscripts.com"><%= Allscripts.Impact.ConfigKeys.VeradigmSupportMailAddress  %></asp:HyperLink>
                        </td>
                    </tr>
                </table>
    </form>
