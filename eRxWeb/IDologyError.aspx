<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.IDologyError" Title="IDology Error"
    CodeBehind="IDologyError.aspx.cs" %>
                            ...
                            <div>
                                <asp:Panel ID="pnlRegisterManually" runat="server">
                                    <p style="padding-top: 10px; padding-left: 15px;">
                                        There was an error in your electronic ID Proofing. You can either attempt to retry
                                        or you can complete the manual ID Proofing form and fax it to us.
                                        <br />
                                        <br />
