<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.UserChallenge" Title="End User License Agreement"
    CodeBehind="UserChallenge.aspx.cs" %>
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="h1title">
                            <span class="indnt Phead">ID Proofing </span>
                        </td>
                    </tr>
                    <tr class="h2title">
                    ...
                    <tr>
                        <td>
                                ...
                                <tr>
                                    <td>
                                        <span class="Phead">Register for
                                            <asp:Label ID="lblProductName" runat="server" CssClass="Phead"></asp:Label><asp:Label
                                                ID="lblStepNo" runat="server" CssClass="Phead"> (Step 3 of 3)</asp:Label></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        These questions are related to your public information our search returned.
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <tr>
                                            <td>
                                                <asp:Panel ID="panQ1" runat="server" Width="100%">
                            ...
                            <table class="questionTable">
                                <tr>
                                    <td>
                                        <asp:Panel ID="panQ2" runat="server" Width="100%">
