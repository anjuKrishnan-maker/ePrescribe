...
namespace eRxWeb
{
public partial class ProviderToPOBReport : BasePage
{
    protected const string reportID = "ProviderToPOB";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Page.Request.QueryString["ReportID"] != null && Page.Request.QueryString["ReportID"] == "ProviderToPOB")
            {
                Page.Title = lblReportTitle.Text = "Provider To POB Association Report";
            }
        }
    }
