<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.PatientMedRecDetailRpt"  MasterPageFile="~/PhysicianMasterPageBlank.master" Codebehind="PatientMedRecDetailRpt.aspx.cs" %>
                ...
                <table border="1" width="100%" cellpadding="0" cellspacing="0" bordercolor="#b5c4c4">
                    <tr>
                        <td class="Phead indnt h1title" >
                            Medication and Med Allergy Reconciliation Detail Report</td>
                    </tr>
                    <tr class="h2title">
                    <td></td>
                    </tr>
