<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="eRxWeb.Controls_ePAStatusInfo" Codebehind="ePAStatusInfo.ascx.cs" %>
                ...
                <td>
                    <div id="questionReview" runat="server" style="border: solid 1px black">
                        <table cellpadding="2px">
                            ...
                            <tr>
                                <td>
                                    <asp:Literal ID="litExpirationDetail" runat="server"></asp:Literal>
                                </td>
                            </tr>--%>
                            <tr>
                                <td>
...
<ajaxToolkit:ModalPopupExtender ID="mpeEPAStatus" runat="server" BehaviorID="mpeEPAStatus"
