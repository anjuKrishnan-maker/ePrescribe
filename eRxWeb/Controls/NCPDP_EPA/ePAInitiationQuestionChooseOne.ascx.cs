...
namespace eRxWeb
{
    public partial class Controls_ePAInitiationQuestionChooseOne : BaseControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            questionHolder.Attributes.Add("ePACurrentQuestionType", "CO");
            ...
            for (int index = 0; index < _baseQuestion.Answers.Count; index++)
            {
                ...
                option.Attributes.Add("class", "ePARadioButton");
                ...
                questionRadios.Controls.Add(holder);
                questionRadios.Controls.Add(new HtmlGenericControl("br"));
