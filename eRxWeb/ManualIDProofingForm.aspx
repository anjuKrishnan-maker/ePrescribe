<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.ManualIDProofingForm" CodeBehind="ManualIDProofingForm.aspx.cs" %>
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="h1title">
                            <span class="indnt Phead" style="padding-left: 15px;">Manual ID Proofing Form</span>
                        </td>
                    </tr>
                    <tr class="h2title">
                        ...
                        <td>
                            <div>
                                <table width="100%" cellpadding="5">
                                    <tr>
                                        <td align="center">
                                            <img src="images/Allscripts/Allscripts_Logo.jpg" width="272" height="70" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            Welcome to the ID Proofing process for Veradigm ePrescribe™.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">                                            
                                            For this step of the ePrescribe Registration, we ask that you complete the form below in its entirety and fax to <b>919.800.6001</b> or email to ePrescribe Support at <b>ePrescribesupport@veradigmhealth.com</b>
                                        </td>
                                    </tr>
                                </table>
                                    <br />
                                ...
                                <table width="100%">
                                    <tr>
                                        <td>After filling in all the information below, <b>don’t forget</b> to include all the <b>“required”</b> copies of your credentials! Including this information, the first time will expedite the credentialing process.
                                            <ul>
                                                <li>Copy of your DEA Number certificate</li>
                                                <li>Copy of your State License Number with Expiration date</li>
                                                <li>Government issued ID (such as driver’s license or passport)</li>
                                                <li>Form needs to be notarized with the seal present and notary’s stamp</li>
                                            </ul>
                                        </td>
                                    </tr>                                                                        
                                    <tr>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td>
                                            We are confident that you and your patients will enjoy the safety and advantages offered
                                            by electronic prescribing with ePrescribe by Allscripts Healthcare, LLC.
                                            If you have any questions or concerns, please contact <a href="mailto:eprescribesupport@veradigmhealth.com" style="color:blue">eprescribesupport@veradigmhealth.com</a>                                            
                                            <br /><br />
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table width="100%" cellpadding="10" style="page-break-after: always;">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            _________________________________<b>State</b>________
                                            <b>Zip</b> ______________
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 117px">
                                ...
                                <table cellpadding="10">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            _________________________________________________
                                            <br />
                                            <span><b>Please print clearly and legibly as you will receive a confirmation email to this address once the process is completed</b></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="color:red;">
                                            <b>For security purposes, please provide your mother's maiden name. We will not be able to process your application without this information.</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <table  cellpadding="10px" style="background-color: #D8D8D8;page-break-after: always;">
                                    <tr>
                                        <td colspan="4">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            IV&nbsp&nbsp&nbsp&nbsp V&nbsp&nbsp&nbsp&nbsp <span style="font-size:small">Circle all that apply</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <table width="100%" cellpadding="10" style="page-break-after: always;">
                                    <tr>
                                        <td>
                                            Allscripts ePrescribe (TM) AUTHORIZATION
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            THIS IS A LEGAL AGREEMENT BETWEEN YOU (DEFINED BELOW) AND ALLSCRIPTS HEALTHCARE, 
                                            LLC (“ALLSCRIPTS”). BEFORE SUBMITTING ANY DATA OR INFORMATION TO ALLSCRIPTS AS PART 
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            the information and data submitted to Allscripts Healthcare, LLC as part of the 
                                            ...
                                            that Allscripts Healthcare, LLC has the right to (i) take all steps necessary to 
                                            ...
                                            You agree to defend, indemnify, and hold Allscripts Healthcare, LLC, its officers, 
                                            ...
                                            the provision, receipt or use of any Data submitted to Allscripts Healthcare, LLC 
                                            hereunder. ALLSCRIPTS HEALTHCARE, LLC RESERVES THE RIGHT, IN ITS SOLE DISCRETION, 
                                    ...
                                    <tr>
                                        <td>
                                            2. NO WARRANTIES; DISCLAIMER: ALLSCRIPTS HEALTHCARE, LLC, ON ITS OWN BEHALF AND 
                                            ...
                                            EVENT SHALL ALLSCRIPTS HEALTHCARE, LLC, ITS LICENSORS, SUPPLIERS OR ANY THIRD PARTIES 
                                            ...
                                            TORT OR ANY OTHER LEGAL THEORY. ALLSCRIPTS HEALTHCARE, LLC SHALL BE LIABLE ONLY 
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            you and Allscripts Healthcare, LLC with respect to ePrescribe. You expressly agree 
                                            that exclusive jurisdiction for any dispute with Allscripts Healthcare, LLC, or 
                                            ...
                                            any such dispute including any claim involving Allscripts Healthcare, LLC or its 
                                    ...
                                    <tr>
                                        <td>
                                            September 2019
                                            <br />
                                            Confidential and Proprietary, Allscripts Healthcare, LLC
                                            <br />
                                        </td>
                                    </tr>
                                     <tr>
                                ...
                                <table style="page-break-after: always;" width="100%" cellpadding="10">                                                                     
                                    <tr>
                                        <td>
                                            <b>Provider signature:</b> _______________________________________ <b>Date:</b>
                                            __________________________
                                ...
                                <table width="100%" cellpadding="10">                                                                     
                                    ...
                                    <tr>
                                        <td>                                            
                                                ...
                                                &nbsp;Please fax this form in its entirety and requisite documents to 919.800.6001 or email to <a href="mailto:eprescribesupport@veradigmhealth.com" style="color:blue">eprescribesupport@veradigmhealth.com</a><br /><br /><br />
                                                &nbsp;IDs must be issued by a national government agency and must include a photo of the applicant. Group B and C IDs can be issued by a government agency (federal, state or local) or other reputable organization and may not include a photo of the applicant.
                                        </td>                                        
                                    </tr>                                    
                                </table>                            
                        </td>
