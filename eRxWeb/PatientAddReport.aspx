<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PhysicianMasterPageBlank.master" Inherits="eRxWeb.PatientAddReport" Title="Patient Entry Report" Codebehind="PatientAddReport.aspx.cs" %>
                    ...
                    <tr class="h3title">
                        <td>
                            <!--<asp:button id="btnPrint" cssclass="btnstyle" runat="server" text="Print Report"
                                />&nbsp;&nbsp;-->
                             <asp:button id="btnClose" cssclass="btnstyle" runat="server" text="Back" TabIndex="4" onclick="btnClose_Click"
