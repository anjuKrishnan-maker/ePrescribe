<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.PrintCoupons" Codebehind="PrintCoupons.aspx.cs" %>
...
<%} %>
<body>
    <asp:Literal ID="litHtmlOutput" runat="server"></asp:Literal>
