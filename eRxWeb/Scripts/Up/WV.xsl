						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td width="49%" class="centerSmall">
										This prescription may be filled with a generically
										equivalent drug product unless the words 'Brand
										Medically Necessary' are written, in the practitioner's
										own handwriting, on this prescription form.
									</td>
								</tr>
							</table>
						</td>
