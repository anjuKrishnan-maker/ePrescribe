					...
					<tr>
						...
						<td>
							<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
								...
								<tr>
									<td colspan="3" class="leftalign">
										In order for a brand name product to be dispensed, prescriber must hand write <b>"Brand Necessary"</b> or <b>"Brand Medically Necessary"</b> in the space below.
									</td>
								</tr>
								<tr>
									<td colspan="3">
										<table width="200" height="42"  border="0" cellpadding="0" cellspacing="" class="table">
											<tr>
												<td>
												</td>
											</tr>
