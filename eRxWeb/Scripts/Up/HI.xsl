        ...
        <table width="100%" height="98%" style="overflow:hidden" border="0" cellspacing="0" cellpadding="0" bordercolor="blue">
          ...
          <xsl:value-of select="NewDataSet/Prescription/DosageDescription"/>
			...
			<tr>
				<!-- Signature Line -->
				<td>
					<table widt="340"  border="0" cellspacing="0" cellpadding="0">
						<tr>
			                <xsl:if test="NewDataSet/Prescription/DAW='Y'">
								<td width="49%" style="vertical-align:bottom" class="headName">Do Not Substitute - Brand Medically Necessary</td>
			                </xsl:if>
				...
				<td>
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="47%" align="center" class="Itallic">Refills Authorized <xsl:value-of select="NewDataSet/Prescription/RefillQuantity"/> Time(s)</td>
