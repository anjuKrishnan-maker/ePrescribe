					...
					<tr>
						...
						<td>
							<table width="100%"  border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<xsl:choose>
										<xsl:when test="NewDataSet/Practice/State='WA'">
											<td class="NormalCenterSmall">SUBSTITUTION PERMITTED</td>
											<td></td>
											<td class="NormalCenterSmall">DISPENSE AS WRITTEN</td>
										</xsl:when>
										<xsl:when test="NewDataSet/Practice/State='MO'">
											<td class="NormalCenterSmall">Substitution Permitted</td>
											<td></td>
											<td class="NormalCenterSmall">Dispense as Written</td>
										</xsl:when>
										<xsl:when test="NewDataSet/Practice/State='WY'">
											<td class="NormalCenterSmall">substitution permitted</td>
											<td></td>
											<td class="NormalCenterSmall">dispense as written</td>
										</xsl:when>
										<xsl:when test="NewDataSet/Practice/State='TN'">
											<td class="NormalCenterSmall">Substitution allowed</td>
											<td></td>
											<td class="NormalCenterSmall">Dispense as written</td>
										</xsl:when>
									</xsl:choose>
