    ...
    <html>
      ...
      <body class="LeftMargin">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0" bordercolor="blue">
            ...
            <td>
              <table width="100%">
                <tr>
                  ...
                  <td class="leftboldsmaller"  width="50%">
          ...
          <tr>
            <td>
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td align="center" class="small">Dispense as Written</td>
                  <td align="center" class="small">&#xA0;</td>
                  <td align="center" class="small">May Substitute</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td class="small" align="center">Prescription is void if more than one (1) prescription is written per blank.</td>
          </tr>
