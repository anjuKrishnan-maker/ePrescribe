						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<xsl:if test="NewDataSet/Prescription/DAW='Y'">
									<td width="49%" class="headName" align="center" style="vertical-align:middle">No Substitution</td>
								</xsl:if>
							...
							<tr>
								...
								<td width="49%" class="centerjustify">
									Interchange is mandated unless the practitioner writes the words
									&quot;no substitution&quot;in this space (above)
								</td>
							</tr>
						</table>
					</td>
