  ...
  <xsl:template match="/">
    <html>
      ...
      <body class="LeftMargin">
        <table width="94%" height="90%" style="overflow:hidden" border="0" cellspacing="0" cellpadding="0" bordercolor="blue">
          <tr>
            <td width="100%"></td>
          </tr>
          <tr>
				...
				<tr>
					...
					<td>
						<table width="100%"  border="0" cellspacing="0" cellpadding="0" bordercolor="red">
							...
							<tr>
								<td width="6%"></td>
								<td width="88%" class="NormalCenterSmall">substitution permissable</td>
								<td width="6%"></td>
							</tr>
							<tr>
								<td colspan="3"></td>
