              ...
              <xsl:value-of select="NewDataSet/Prescription/DosageDescription"/>
							...
							<table width="100%"  border="0" cellspacing="0" cellpadding="0" bordercolor="red">
								<xsl:if test="NewDataSet/Prescription/DAW='Y'">
									<tr>
										...
										<td width="40%" class="Itallic">Voluntary Formuarly Permitted</td>
										<td width="2%">
											<xsl:text> </xsl:text>
										</td>
										<td width="49%">
									...
									<tr>
										...
										<td width="40%" class="Itallic">Dispense as Written</td>
										<td width="2%">
											<xsl:text> </xsl:text>
										</td>
										<td width="49%">
								...
								<xsl:if test="NewDataSet/Prescription/DAW='N'">
									<tr>
										...
										<td width="40%" class="Itallic">Voluntary Formulary Permitted</td>
										<td width="2%">
											<xsl:text> </xsl:text>
										</td>
										<td width="49%">
					...
					<tr>
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="49%" class="footer">If neither box is marked, a Voluntary Formulary product must be dispensed.</td>
								</tr>
								<tr>
									<td>
										<xsl:text> </xsl:text>
