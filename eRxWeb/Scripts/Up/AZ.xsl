								...
								<table width="82%"  border="0" cellpadding="0" cellspacing="0" class="table">
									<tr>
										<td width="100%" class="subheading">
											...
											<xsl:value-of select="NewDataSet/Patient/State"/><xsl:text> </xsl:text>
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="2%" height="42">
								<xsl:text> </xsl:text>	<!-- Force the column open, for whatever reason, couldn't use a spacer gif (border always printed). &nbsp doesn't work -->
							</td>
							<td width="49%">
								<table width="100%" height="42"  border="0" cellpadding="0" cellspacing="0" class="table">
									<tr>
						...
						<tr>
							...
							<td></td>
							<td class="NormalCenterSmall">substitution permissible</td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<!-- Space between signature lines and below message-->
				<td></td>
			</tr>
			<tr>
				<td class="Normal">THIS PRESCRIPTION MAY BE FILLED BY THE PRESCRIBING DOCTOR OR BY A PHARMACY OF YOUR CHOICE.</td>
			</tr>
			<tr>
				<!--Space between above message and next line-->
				<td></td>
			</tr>
			<tr>
				<td>
