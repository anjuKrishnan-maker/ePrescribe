          ...
          <tr>
            <td>
						...
						<td>
							<table width="320"  border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td colspan="3">
										<table width="77%"  border="0" cellpadding="0" cellspacing="0" class="table">
											<tr>
              ...
              <xsl:value-of select="NewDataSet/Prescription/DosageDescription"/>
					...
					<tr>
						<td>
							<table width="320"  border="0" cellspacing="0" cellpadding="0" bordercolor="red">
								<xsl:if test="NewDataSet/Prescription/DAW='Y'">
									<tr>
										...
										<td width="126" class="leftboldsmall">May Substitute</td>
										<td width="2%">
											<xsl:text> </xsl:text>
										</td>
										<td width="158">
									...
									<tr>
										...
										<td width="126" class="leftboldsmall">May Not Substitute </td>
										<td width="2%">
											<xsl:text> </xsl:text>
										</td>
										<td width="158">
											<table width="158" border="0" cellpadding="0" cellspacing="0" class="table">
												<tr>
													<td>
														<xsl:text> </xsl:text>
													</td>
									...
									<tr>
										...
										<td width="2%"></td>
										<xsl:choose>
											<xsl:when test="NewDataSet/Practice/State='IL'">
												<td width="158" class="NormalCenterSmall">Signature of Prescriber</td>
											</xsl:when>
											<xsl:when test="NewDataSet/Practice/State='IA'">
												<td width="158"  class="NormalCenterSmall">Prescriber Signature</td>
											</xsl:when>
										</xsl:choose>
									</tr>
								</xsl:if>
					...
					<tr>
						<td>
							<table width="320" border="0" cellspacing="0" cellpadding="0" bordercolor="red">
								<tr>
									<td width="35" class="Itallic">Written:</td>
									<td width="15%" class="Itallic">
										<xsl:value-of select="NewDataSet/Prescription/Created"/>
									</td>
									<td width="170" align="center" class="Itallic">
										Refills Authorized <xsl:value-of select="NewDataSet/Prescription/RefillQuantity"/> Time(s)
									</td>
									<td width="15" class="Itallic">Rx:</td>
									<td width="7%" class="Itallic">
										<table width="7%" border="0" cellpadding="0" cellspacing="0" class="table">
											<tr>
