							...
							<tr>
								<td width="100%">
									<xsl:if test="NewDataSet/Prescription/DAW='Y'">
										<table width="49%" height="38"  class="tableAll">
											<tr>
												<td class="headName" align="center"> brand name necessary </td>
											</tr>
										</table>
									</xsl:if>
									<xsl:if test="NewDataSet/Prescription/DAW='N'">
										<table width="49%" height="38">
											<tr>
												<td></td>
											</tr>
										</table>
								...
								<td width="49%">
									<table width="49%" border="0" cellspacing="0" cellpadding="0" class="table">
										<tr>
											<td height="38"></td>
										</tr>
									</table>
