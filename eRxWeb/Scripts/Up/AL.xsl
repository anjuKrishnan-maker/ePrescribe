    ...
    <html>
      ...
      <body class="LeftMargin">
        <table width="100%" height="98%" style="overflow:hidden" border="0" cellspacing="0" cellpadding="0" bordercolor="blue">
          <tr>
            <!-- Leave a border at the top of the page -->
            <td width="100%"></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<tr>
				<!--space between header info and provider name-->
				<td></td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
						...
						<tr>
							...
							<td colspan="3">
								<table width="82%"  border="0" cellpadding="0" cellspacing="0" class="table">
									<tr>
          ...
          <xsl:value-of select="NewDataSet/Prescription/DosageDescription"/>
			...
			<tr>
				...
				<td>
					<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
						<tr>
							<td width="49%">
								<table width="100%" height="42"  border="0" cellpadding="0" cellspacing="" class="table">
									<tr>
										<td></td>
									</tr>
								</table>
						...
						<tr>
							<xsl:choose>
							<xsl:when test="NewDataSet/Practice/State='AL'">
								<td class="NormalCenterSmall">dispense as written</td>
								<td></td>
								<td class="NormalCenterSmall">product selection permitted</td>
							</xsl:when>
							<xsl:when test="NewDataSet/Practice/State='DE' or NewDataSet/Practice/State='LA' or NewDataSet/Practice/State='SC' or NewDataSet/Practice/State='UT'">
								<td class="NormalCenterSmall">Dispense as Written</td>
								<td></td>
								<td class="NormalCenterSmall">Substitution Permitted</td>
							</xsl:when>
							<xsl:when test="NewDataSet/Practice/State='KS'">
								<td class="NormalCenterSmall">Dispense as Written</td>
								<td></td>
								<td class="NormalCenterSmall">Brand Exchange permissible</td>
							</xsl:when>
							<xsl:when test="NewDataSet/Practice/State='MS'">
								<td class="NormalCenterSmall">dispense as written</td>
								<td></td>  
								<td class="NormalCenterSmall">substitution permitted</td>
							</xsl:when>
			...
			<tr>
				<!-- Space between signature lines and footer info -->
				<td></td>
			</tr>
            <tr>
				<td>
