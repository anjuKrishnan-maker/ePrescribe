					...
					<tr>
						<td>
							<table width="100%">
								<tr>
									<td class="leftboldsmall" width="50%">
										<xsl:if test="NewDataSet/Provider/DPS !=''">DPS: </xsl:if>
										<xsl:value-of select="NewDataSet/Provider/DPS"/>
									</td>
									<td class="leftboldsmall" width="50%">
										<xsl:if test="NewDataSet/PhysicianAssistant/DPS !=''">DPS: </xsl:if>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="2%" height="42">
										<xsl:text> </xsl:text>
										<!-- Force the column open, for whatever reason, couldn't use a spacer gif (border always printed). &nbsp doesn't work -->
									</td>
									<xsl:if test="NewDataSet/Prescription/DAW='Y'">
										<td width="49%" class="headNameMiddle">Brand Medically Necessary</td>
									</xsl:if>
								...
								<tr>
									...
									<td width="49%" class="centerSmall">A generically equivalent drug product may be dispensed unless the prescriber hand writes the words 'Brand Necessary' or 'Brand Medically Necessary' on the face of the prescription.</td>
								</tr>
							</table>
						</td>
					</tr>
