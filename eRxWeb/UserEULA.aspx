<%@ Page Language="C#" AutoEventWireup="true" Inherits="eRxWeb.UserEULA"
    Title="End User License Agreement" Codebehind="UserEULA.aspx.cs" %>
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="h3title">
                        <td>
                            <asp:Button ID="btnAccept" runat="server" CssClass="btnstyle" Text="I Agree" ToolTip="I agree and accept the End User License Agreement"
                                OnClick="btnAccept_Click" />
                            <asp:Button ID="btnDecline" runat="server" CssClass="btnstyle" Text="I Decline" ToolTip="I decline the End User License Agreement"
                                OnClick="btnDecline_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div id="eulaContent" runat="server" style="height: 320px; width: 670px; overflow-y: scroll">
                            </div>
                        </td>
                    </tr>
                </table>
